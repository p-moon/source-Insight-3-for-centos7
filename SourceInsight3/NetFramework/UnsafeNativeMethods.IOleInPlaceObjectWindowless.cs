public interface IOleInPlaceObjectWindowless
{
	...
	public abstract virtual int Advise(System.Runtime.InteropServices.ComTypes.IAdviseSink pAdvSinkout , System.Int32& cookie) {}
	public abstract virtual int Unadvise(int dwConnection) {}
	public abstract virtual int EnumAdvise(out System.Runtime.InteropServices.ComTypes.IEnumSTATDATA& e) {}
	...
	public abstract virtual int OnWindowMessage(int msg, int wParam, int lParamout , int plResult) {}
	public abstract virtual int GetDropTarget(out object ppDropTarget) {}
}
